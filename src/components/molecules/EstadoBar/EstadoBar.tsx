...
export type EstadoClave = "muymalo" | "malo" | "regular" | "bueno" | "excelente";
...
export const ESTADOS: EstadoInfo[] = [
    { key: "muymalo", label: "Muy malo", color: "#f44336" },
...
type EstadoBarProps =
    | { mode: "edit"; value: EstadoClave | null; onChange: (estado: EstadoClave) => void }
...
function EstadoBar(props: EstadoBarProps) {
    ...
    const controllingIndex =
        props.mode === "edit" && hoverIndex !== null ? hoverIndex : currentIndex;
